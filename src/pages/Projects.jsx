    ...
    programManager: [
      {
        ...
        star: {
          situation: 'Fragmented systems created customer experience inefficiencies.',
        ...
        tags: ['Program Management', 'Change Management', 'Stakeholder Alignment'],
      },
      {
        title: 'eCommerce Platform Migration',
        context: 'Migrate legacy eCommerce system to modern cloud platform.',
        star: {
          situation: 'Outdated eCommerce platform limited growth and customer experience.',
          task: 'Lead migration to scalable, modern headless eCommerce solution.',
          action: 'Vendor selection, data migration strategy, user training, go-live planning.',
      ...
      },
      {
        ...
        context: 'Enterprise-wide automation program to enhance efficiency and accuracy.',
        star: {
          ...
          result: '70% reduction in manual tasks, 50% faster processing times, 90% accuracy improvement.',
        },
    ...
    engineering: [
      {
        ...
        star: {
          situation: 'Monolithic architecture limited scalability and team velocity.',
      ...
      },
      {
        ...
        context: 'Real-time data processing for eCommerce analytics and personalization.',
        star: {
          situation: 'eCommerce data was siloed and not actionable for business decisions.',
          task: 'Build real-time data pipeline for customer behavior analytics.',
          action: 'Kafka, Apache Spark, data lake architecture, ML feature engineering.',
      ...
      },
      {
        ...
        star: {
          situation: 'Manual testing created deployment bottlenecks and quality issues.',
          task: 'Build end-to-end automated testing framework.',
          action: 'Selenium, API testing, performance testing, CI/CD integration.',
      ...
      },
      {
        ...
        star: {
          situation: 'Manual processes limited product intelligence and automation.',
      ...
      },
      {
        ...
        star: {
          ...
          action: 'React, D3.js, Python backend, data visualization best practices.',
    ...
    qa: [
      {
        ...
        star: {
          ...
          action: 'Phased migration, zero-trust patterns, automation gates in CI/CD.',
          result: '98% adoption in first quarter, audit findings reduced by 80%.',
        },
      ...
      },
      {
        ...
        star: {
          situation: 'eCommerce platform had critical bugs affecting customer experience.',
          task: 'Implement comprehensive QA strategy for eCommerce functionality.',
          action: 'Test automation, performance testing, security testing, user acceptance testing.',
          result: '95% bug-free releases, 40% improvement in customer satisfaction.',
        },
      ...
      },
      {
        ...
        star: {
          ...
          result: 'Decision latency reduced; roadmap aligned to measurable KPIs.',
        },
      ...
      },
      {
        ...
        star: {
          situation: 'Manual testing processes couldn\'t keep up with release velocity.',
      ...
      },
      {
        ...
        star: {
          ...
          action: 'Data profiling, validation rules, monitoring dashboards, alerting.',
