...
export const personas = {
  engineering: {
    ...
    description: 'Customer impact-driven technical leader with 15+ years of experience delivering enterprise cloud-native SaaS solutions, and large-scale digital/IT transformations for high-growth organizations.',
  ...
  programManager: {
    ...
    description: 'PMP-certified Program Management Leader with over 15 years of experience directing high-impact, cross-functional programs, with proven success in modernizing technology, streamlining operations, and delivering new revenue streams.',
  ...
  qa: {
    ...
    description: 'Strategic QA and Engineering Leader with 20+ years of experience delivering enterprise SaaS, cloud-native solutions with high quality assurance and control, embedding quality early in the SDLC.',
